...
@SET MVNW_DISTRIBUTION_VERSION=3.9.16
@SET MVNW_DISTRIBUTION=apache-maven-%MVNW_DISTRIBUTION_VERSION%
@SET MVNW_DISTRIBUTION_URL=%MVNW_REPOURL%/org/apache/maven/apache-maven/%MVNW_DISTRIBUTION_VERSION%/%MVNW_DISTRIBUTION%-bin.zip
